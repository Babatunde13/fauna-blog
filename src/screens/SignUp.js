        ...
        <form className="mt-8 space-y-6">
          ...
          <div className="rounded-md shadow-sm -space-y-px">
            <div>
              ...
              <input 
                ref={name} id="name" name="name" type="text" 
            ...
            <div>
              ...
              <input 
                ref={email} id="email-address" name="email" type="email" 
            ...
            <div>
              ...
              <input 
                ref={username} id="username" name="username" type="text" 
                autoComplete="text" required 
                className="appearance-none rounded-none relative block w-full px-3 py-2 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-t-md focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 focus:z-10 sm:text-sm" 
            ...
            <div>
              ...
              <input 
                ref={password} id="password" name="password" type="password" 
            ...
            <div>
              ...
              <input 
                ref={confirm_password} id="confirm_password" name="confirm_password" 
